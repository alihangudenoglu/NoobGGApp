            ...
            modelBuilder.Entity("NoobGGApp.Domain.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 11, 28, 21, 21, 23, 213, DateTimeKind.Unspecified).AddTicks(6136), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
            ...
            modelBuilder.Entity("NoobGGApp.Domain.Entities.GameRegion", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 11, 28, 21, 21, 23, 213, DateTimeKind.Unspecified).AddTicks(9776), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
