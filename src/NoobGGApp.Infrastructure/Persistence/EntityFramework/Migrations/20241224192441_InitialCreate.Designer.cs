...
namespace NoobGGApp.Infrastructure.Persistence.EntityFramework.Migrations
{
    ...
    [Migration("20241224192441_InitialCreate")]
            ...
            modelBuilder.Entity("NoobGGApp.Domain.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 12, 24, 19, 24, 41, 127, DateTimeKind.Unspecified).AddTicks(5315), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
            ...
            modelBuilder.Entity("NoobGGApp.Domain.Entities.GameRegion", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 12, 24, 19, 24, 41, 127, DateTimeKind.Unspecified).AddTicks(8266), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
